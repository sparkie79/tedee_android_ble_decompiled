...
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.CLIENT_AP_TRAFFIC
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.DIGEST_ALGORITHM
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.LEN_AUTH_TAG
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.LEN_HEADER
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.LEN_LENGTH
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.OFFSET_DATA
import tedee.mobile.sdk.ble.bluetooth.secure.SecureConnectionConstants.SERVER_AP_TRAFFIC
...
internal val EMPTY_SESSION_ID = byteArrayOf(0, 0, 0, 0)
  ...
  fun parseVerify(incomingMessage: ByteArray) {
    try {
      peerProtector?.let { peerProtector ->
        ...
        var offset = 0
        var len =
          MessageCipher.getLength(message, offset)
