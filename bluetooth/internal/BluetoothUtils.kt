...
internal fun buildUnencryptedMessageToSend(mainMessage: Byte, payload: ByteArray? = null): ByteArray {
...
internal fun buildSecureEstablishMessageToSend(header: Byte, message: ByteArray): ByteArray {
...
internal fun extractSerialNumber(uuids: List<String>?, vararg servicesToIgnore: String) =
  extractSerialNumber(uuids, servicesToIgnore.toList())

internal fun extractSerialNumber(uuids: List<String>?, servicesToIgnore: List<String>): String? {
...
internal fun parseSerialNumber(uuid: String): String? {
  return try {
